...
namespace A5Tests
{
    public class UnitTests
    {
        ...
        // Test for additional unknown character '!'
        [Fact]
        public void TestUnknown3()
        {
            using (FileStream test4 = new FileStream("../../../testUser4.in", FileMode.Open))
            {
                using (A5.Variables.inFileStream = new StreamReader(test4))
                {
                    while ((A5.Variables.line = A5.Variables.inFileStream.ReadLine()) != null)
                    {
                        A5.Variables.lineArray = A5.Variables.line.ToCharArray();
