    ...
    public class A5
    {
        ...
        public static void getChar()
        {
            ...
            if (Variables.nextChar != Variables.EOF && Variables.nextChar != Variables.EOL)
            {
                ...
                {
                    // Super hacky way to do this, but hey
                    // If variable is '=', check previous and next char for classification
                    if (Variables.nextChar == '=' && Variables.iterator < Variables.lineArray.Length - 1)
                    {
                        // Check next char for '=' 
                        if (Variables.lineArray[Variables.iterator + 1] == '=')
                        {
                            Console.WriteLine("Next is =");
                            Variables.charClass = Variables.LOG_OP;
                        }
                        // Check previous char for '='
                        else if (Variables.lineArray[Variables.iterator - 1] == '=')
                        {
                            Console.WriteLine("Previous is =");
                            Variables.charClass = Variables.LOG_OP;
                        }
                        // Check previous char for '!'
                        else if (Variables.lineArray[Variables.iterator - 1] == '!')
                        ...
                        {
                            Console.WriteLine("'=' to Unknown");
                            Variables.charClass = Variables.UNKNOWN;
                        }
                    }
                    // If var is '!', check next char for classification
                    else if (Variables.nextChar == '!' && Variables.iterator < Variables.lineArray.Length - 1)
                    {
                        // Check what next char is
                        if (Variables.lineArray[Variables.iterator + 1] == '=')
                        {
                            // Doesn't work
                            Console.WriteLine("Next char is '='");
                            Variables.charClass = Variables.LOG_OP;
                        }
                        // Else, set to unknown
                        else 
