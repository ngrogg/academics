...
class Actions:
    ...
    _directions = {Directions.NORTH: (0, 1),
                   ...
                   Directions.WEST:  (-1, 0),
                   Directions.STOP:  (0, 0)}
    #Bug fix by Travis Mandel 9/22/2019
    _orderedDirections = [Directions.WEST, Directions.STOP, Directions.EAST, Directions.NORTH, Directions.SOUTH]
    _directionsAsList = []
    for dir in _orderedDirections:
        _directionsAsList.append((dir, _directions[dir]))
    #_directionsAsList = [(Directions.WEST, (-1, 0)), (Directions.STOP, (0, 0)), (Directions.EAST, (1, 0)), (Directions.NORTH, (0, 1)),(Directions.SOUTH, (0, -1))]#list(_directions.items())
